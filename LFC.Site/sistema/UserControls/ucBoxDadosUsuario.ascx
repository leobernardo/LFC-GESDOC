<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucBoxDadosUsuario.ascx.cs" Inherits="LFC.GesDoc.Site.sistema.UserControls.ucBoxDadosUsuario" %>
...
<li class="dropdown user user-menu">
    ...
    <ul class="dropdown-menu">
        ...
        <li class="user-footer">
            <div class="pull-left">
                <a href="../Usuarios/VisualizarPerfil.aspx" class="btn btn-default btn-flat">Perfil</a>
            </div>
