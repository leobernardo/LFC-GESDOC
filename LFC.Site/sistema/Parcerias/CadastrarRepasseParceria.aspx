<%@ Page Title="" Language="C#" MasterPageFile="~/sistema/MasterPages/mpGesDoc.Master" AutoEventWireup="true" CodeBehind="CadastrarRepasseParceria.aspx.cs" Inherits="LFC.GesDoc.Site.sistema.Parcerias.CadastrarRepasseParceria" %>
...
<asp:Content ContentPlaceHolderID="cphCONTEUDO" runat="server">
    ...
    <section class="content-header">
        ...
        <small>cadastrar repasse da parceria</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">Cadastrar Repasse da Parceria</li>
        </ol>
    </section>
