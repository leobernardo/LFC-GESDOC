<%@ Page Title="" Language="C#" MasterPageFile="~/gestor/MasterPages/mpGesDoc.Master" AutoEventWireup="true" CodeBehind="CadastrarTipoDocumento.aspx.cs" Inherits="LFC.GesDoc.Site.gestor.TiposDocumentos.CadastrarTipoDocumento" %>
...
<asp:Content ContentPlaceHolderID="cphCONTEUDO" Runat="Server">
    ...
    <section class="content-header">
        <h1>
        Tipos de Documentos
        <small>cadastrar tipo de documento</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <li class="active">Cadastrar Tipo de Documento</li>
        </ol>
    </section>
