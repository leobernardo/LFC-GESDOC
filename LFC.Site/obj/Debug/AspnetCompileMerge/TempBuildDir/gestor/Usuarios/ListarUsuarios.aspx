<%@ Page Title="" Language="C#" MasterPageFile="~/gestor/MasterPages/mpGesDoc.Master" AutoEventWireup="true" CodeBehind="ListarUsuarios.aspx.cs" Inherits="LFC.GesDoc.Site.gestor.Usuarios.ListarUsuarios" %>
    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <button id="btnCadastrarUsuario" class="btn btn-block btn-primary btn-sm" style="width:150px" onclick="location='CadastrarUsuario.aspx'">Cadastrar Usuário</button>
            </div><!-- /.box-header -->
            <div class="box-body">
                    ...
                    <asp:Repeater ID="Usuarios" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#Eval("Nome")%></td>
                                <td><%#Eval("Email")%></td>
                                <td><a href="AlterarUsuario.aspx?idUsr=<%#Eval("IdUsuario")%>"><button class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></button></a>&nbsp<button class="btn btn-primary btn-xs" onclick="return confirmaExclusao(this, <%#Eval("IdUsuario")%>);"><i class="fa fa-trash"></i></button></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
