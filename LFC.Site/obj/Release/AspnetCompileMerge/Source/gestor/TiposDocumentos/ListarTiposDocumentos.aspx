    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <asp:Button ID="btnCadastrarTipoDocumento" CssClass="btn btn-block btn-primary btn-sm" Width="200" Text="Cadastrar Tipo de Documento" OnClick="CadastrarTipoDocumento" runat="server" />
            </div><!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                    <asp:Repeater ID="TiposDocumentos" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td><%#Eval("DSTipoDocumento")%></td>
                                <td><%#Eval("DSGuardaInterna")%></td>
                                <td><%#Eval("DSGuardaExterna")%></td>
                                <td><a href="AlterarTipoDocumento.aspx?idTpd=<%#Eval("IdTipoDocumento")%>" data-toggle="tooltip" data-placement="top" title="Alterar Tipo de Documento"><i class="fa fa-edit" style="margin-right:10px"></i></a><a href="#" onclick="return confirmaExclusao(this, <%#Eval("IdTipoDocumento")%>);" data-toggle="tooltip" data-placement="top" title="Excluir Tipo de Documento"><i class="fa fa-trash"></i></a></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
