<%@ Page Title="" Language="C#" MasterPageFile="~/sistema/MasterPages/mpGesDoc.Master" AutoEventWireup="true" CodeBehind="AlterarParceria.aspx.cs" Inherits="LFC.GesDoc.Site.sistema.Parcerias.AlterarParceria" %>
...
<asp:Content ContentPlaceHolderID="cphCONTEUDO" runat="server">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Alterar Parceria</li>
        </ol>
    </section>
