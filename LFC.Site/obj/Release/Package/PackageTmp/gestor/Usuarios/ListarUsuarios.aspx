    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <asp:Button ID="btnCadastrarUsuario" CssClass="btn btn-block btn-primary btn-sm" Width="150" Text="Cadastrar Usuário" OnClick="CadastrarUsuario" runat="server" />
            </div><!-- /.box-header -->
            <div class="box-body">
                    ...
                    <asp:Repeater ID="Usuarios" runat="server">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><a href="AlterarUsuario.aspx?idUsr=<%#Eval("IDUsuario")%>" data-toggle="tooltip" data-placement="top" title="Alterar Usuário"><i class="fa fa-edit" style="margin-right:10px"></i></a><a href="#" onclick="return confirmaExclusao(this, <%#Eval("IDUsuario")%>);" data-toggle="tooltip" data-placement="top" title="Excluir Usuário"><i class="fa fa-trash"></i></a></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
                </tbody>
