    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-header">
                <asp:DropDownList ID="ddlTipoDocumento" CssClass="form-control" Width="300" DataTextField="DSTipoDocumento" DataValueField="IDTipoDocumento" AutoPostBack="true" OnSelectedIndexChanged="selecionaTipoDocumento" runat="server" />
            </div><!-- /.box-header -->
            <div class="box-body">
