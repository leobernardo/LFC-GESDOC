...
<ul class="sidebar-menu">
    ...
    <li class="treeview">
        <a href="#"><i class="fa fa-exchange"></i> <span>Convênios</span> <i class="fa fa-angle-left pull-right"></i></a>
        <ul class="treeview-menu">
            <li><a href="../Convenios/ListarConvenios.aspx"><i class="fa fa-circle-o"></i> Listar Convênios</a></li>
        </ul>
    </li>
