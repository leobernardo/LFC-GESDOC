...
namespace LFC.GesDoc.Site.gestor.ServerSideProcessing
{
    public partial class Documentos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Request.QueryString["idTpd"] == "")
                {
                    whereClause = " WHERE arquivado = '0'";
                }
                else
                {
                    if (!String.IsNullOrEmpty(search))
                    {
                        sb.Append(" WHERE idTipoDocumento=" + Request.QueryString["idTpd"] + " AND arquivado = '0' AND (numero LIKE '%" + search + "%'");
                    ...
                    {
                        whereClause = " WHERE idTipoDocumento=" + Request.QueryString["idTpd"] + " AND arquivado = '0'";
                    }
                }
        ...
        protected string getOpcoes(int _IdDocumento)
        {
            try
            {
                ...
                strOpcoes += "<a href=\\\"HistoricoDocumento.aspx?idDoc=" + _IdDocumento + "\\\" data-toggle=\\\"tooltip\\\" data-placement=\\\"top\\\" title=\\\"Histórico do Documento\\\" class=\\\"historicoDocumento\\\"><i class=\\\"fa fa-calendar\\\" style=\\\"margin-right:10px\\\"></i></a>";
                strOpcoes += "<a href=\\\"AlterarDocumento.aspx?idDoc=" + _IdDocumento + "\\\" data-toggle=\\\"tooltip\\\" data-placement=\\\"top\\\" title=\\\"Alterar Documento\\\"><i class=\\\"fa fa-edit\\\" style=\\\"margin-right:10px\\\"></i></a>";
                strOpcoes += "<a href=\\\"#\\\" onclick=\\\"return confirmaExclusao(this, " + _IdDocumento + ");\\\" data-toggle=\\\"tooltip\\\" data-placement=\\\"top\\\" title=\\\"Excluir Documento\\\"><i class=\\\"fa fa-trash\\\"></i></a>";
