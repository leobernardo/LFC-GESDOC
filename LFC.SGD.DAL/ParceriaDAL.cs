        ...
        public Parceria ObterDadosPorId(int _IdParceria)
        {
            using (SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBGesDoc"].ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT IDParceria,IDUnidade,NMParceria,DSTipo,DSObjetivo,DSObservacoes,BTPossuiPagamentoRH,BTPossuiRecursosFinanceiros,BTPossuiVigencia,DTInicioVigencia,DTFimVigencia,VLPrevistoAnual,DSArquivoAnexo,DSStatus FROM TB_Parceria WHERE IDParceria = " + _IdParceria, objConn);
        ...
        public Parceria ObterUltimaCadastrada()
        {
            using (SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBGesDoc"].ConnectionString))
            {
                try
                {
                    ...
                    if (dr1.Read())
                    {
                        SqlCommand cmd2 = new SqlCommand("SELECT IDParceria,IDUnidade,NMParceria,DSTipo,DSObjetivo,DSObservacoes,BTPossuiPagamentoRH,BTPossuiRecursosFinanceiros,BTPossuiVigencia,DTInicioVigencia,DTFimVigencia,VLPrevistoAnual,DSArquivoAnexo,DSStatus FROM TB_Parceria WHERE IDParceria = " + dr1["IDParceria"], objConn);
        ...
        public void Cadastrar(object obj)
        {
            using (SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBGesDoc"].ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO TB_Parceria(IDUnidade,NMParceria,DSTipo,DSObjetivo,DSObservacoes,BTPossuiPagamentoRH,BTPossuiRecursosFinanceiros,BTPossuiVigencia,DTInicioVigencia,DTFimVigencia,VLPrevistoAnual,DSArquivoAnexo,DSStatus) VALUES(@IDUnidade,@NMParceria,@DSTipo,@DSObjetivo,@DSObservacoes,@BTPossuiPagamentoRH,@BTPossuiRecursosFinanceiros,@BTPossuiVigencia,@DTInicioVigencia,@DTFimVigencia,@VLPrevistoAnual,@DSArquivoAnexo,@DSStatus)", objConn);
                    cmd.Parameters.Add("@IDUnidade", SqlDbType.Int).Value = p.Unidade.IdUnidade;
                    cmd.Parameters.Add("@NMParceria", SqlDbType.VarChar, 255).Value = p.Nome;
                    cmd.Parameters.Add("@DSTipo", SqlDbType.VarChar, 10).Value = p.Tipo;
                    cmd.Parameters.Add("@DSObjetivo", SqlDbType.Text).Value = p.Objetivo;
        ...
        public IList Listar()
        {
            using (SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBGesDoc"].ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT IDParceria,IDUnidade,NMParceria,DSTipo,DSObjetivo,DSObservacoes,BTPossuiPagamentoRH,BTPossuiRecursosFinanceiros,BTPossuiVigencia,DTInicioVigencia,DTFimVigencia,DSArquivoAnexo,DSStatus FROM TB_Parceria", objConn);
                    SqlDataReader dr = cmd.ExecuteReader();
        ...
        public IList ListarPorUnidade(int _IdUnidade)
        {
            using (SqlConnection objConn = new SqlConnection(ConfigurationManager.ConnectionStrings["DBGesDoc"].ConnectionString))
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT IDParceria,IDUnidade,NMParceria,DSObjetivo,DSObservacoes,BTPossuiPagamentoRH,BTPossuiRecursosFinanceiros,BTPossuiVigencia,DTInicioVigencia,DTFimVigencia,DSArquivoAnexo,DSStatus FROM TB_Parceria WHERE IDUnidade = " + _IdUnidade, objConn);
                    SqlDataReader dr = cmd.ExecuteReader();
